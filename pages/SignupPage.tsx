                ...
                <div className="mx-auto w-full max-w-sm">
                    ...
                    <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                        <div className="flex gap-4">
                            <div className="w-1/2">
                                ...
                                <div className="mt-1">
                                    <input id="first-name" name="first-name" type="text" required className="w-full px-4 py-3 bg-gray-50 border-gray-200 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                                </div>
                            </div>
                             <div className="w-1/2">
                                <label htmlFor="last-name" className="block text-sm font-medium text-text-secondary">Last Name</label>
                                <div className="mt-1">
                                    <input id="last-name" name="last-name" type="text" required className="w-full px-4 py-3 bg-gray-50 border-gray-200 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                                </div>
                            </div>
                        </div>

                        <div>
                            <label htmlFor="work-email" className="block text-sm font-medium text-text-secondary">Work Email ID</label>
                            <div className="mt-1">
                                <input id="work-email" name="work-email" type="email" required className="w-full px-4 py-3 bg-gray-50 border-gray-200 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input id="company-name" name="company-name" type="text" required className="w-full px-4 py-3 bg-gray-50 border-gray-200 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                            </div>
                        </div>
                    ...
                    <div className="mt-6">
                        <button className="w-full flex items-center justify-center px-4 py-3 bg-gray-50 rounded-lg text-text-secondary hover:bg-gray-100 transition-colors border border-gray-200">
                           <IconGoogle />
                           <span className="ml-3 font-medium text-sm">Sign up with Google</span>
                        </button>
                    </div>
