...
const RequestSubmittedPage: React.FC<RequestSubmittedPageProps> = ({ onBackToHomepage }) => {
    return (
        <div className="min-h-screen flex bg-white font-sans text-text-strong">
            ...
            <div className="w-full lg:w-2/5 flex flex-col justify-center p-8 sm:p-16">
                <div className="mx-auto w-full max-w-sm">
                    <IconCheckCircle />
                    <h1 className="text-3xl font-bold mt-6">Request submitted successfully</h1>
                    
                    <div className="mt-6 space-y-4 text-text-secondary">
                        <p>We're reviewing your details. Our team typically <strong className="text-text-strong">approves requests within 24 hours.</strong></p>
                        <p>To ensure a secure and optimized experience, all new Anavsan accounts require admin approval.</p>
                        <p>You'll receive an email once your account is approved. If you have any questions, feel free to <a href="#" className="font-semibold text-primary hover:underline">contact support</a>.</p>
                    </div>
                    ...
                    <div className="mt-8">
                        <button 
                            ...
                            className="w-full flex justify-center items-center px-4 py-3 border border-transparent text-sm font-medium rounded-lg text-primary bg-primary/10 hover:bg-primary/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                        >
                            Back to homepage
                        </button>
                    </div>
